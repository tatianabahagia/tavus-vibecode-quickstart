    ...
    <DialogWrapper>
      ...
      <AnimatedTextBlockWrapper>
        ...
        >
          ...
          <span style={{
            color: '#9EEAFF'
          }}>Build Something Epic?</span>
        </h1>
        <p className="max-w-[650px] text-center text-base sm:text-lg text-gray-400 mb-12">
          Get face-to-face mentoring from an AI expert who can help you brainstorm, debug, and build your hackathon project. From idea to deployment, I've got your back.
        </p>
        <Button
          onClick={handleClick}
